...
export default class MainView {
  ...
  createDepartureInput() {
    this._commonView.createTitle(
      inputConsts.INPUT_TITLE_TAG,
      inputConsts.DEPARTURE_TITLE_CONTENT,
      inputConsts.DEPARTURE_TITLE_IDNAME,
      inputConsts.INPUT_AREA_IDNAME
    );
    this._commonView.createInput(
  ...
  createArrivalInput() {
    this._commonView.createTitle(
      inputConsts.INPUT_TITLE_TAG,
      inputConsts.ARRIVAL_TITLE_CONTENT,
      inputConsts.ARRIVAL_TITLE_IDNAME,
      inputConsts.INPUT_AREA_IDNAME
    );
    this._commonView.createInput(
  ...
  createRadioArea() {
    ...
    const distanceRadio = this._commonView.createInput(
      inputConsts.RADIO_DISTANCE_IDNAME,
      inputConsts.RADIO_AREA_IDNAME,
      inputConsts.RADIO_DISTANCE_TEXT
    );
    ...
    this._commonView.createTitle(
      ...
      '',
      inputConsts.RADIO_AREA_IDNAME,
      inputConsts.RADIO_MARGIN
    );
    this._commonView.createInput(
      inputConsts.RADIO_TIME_IDNAME,
      inputConsts.RADIO_AREA_IDNAME,
      inputConsts.RADIO_TIME_TEXT
    );
    this._commonView.createTitle(
      inputConsts.INPUT_TITLE_TAG,
      inputConsts.RADIO_TIME_TEXT,
  ...
  createButtonArea() {
    ...
    this._commonView.createButton(
      inputConsts.SEARCH_BUTTON_IDNAME,
      inputConsts.SEARCH_BUTTON_TEXT,
      inputConsts.MAIN_IDNAME
    );
  }
}
